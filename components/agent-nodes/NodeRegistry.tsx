...
export const nodeThemeRegistry: Record<NodeTypeKey, NodeTheme> = {
  ...
  logic: {
    ...
    ring: 'ring-blue-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(59,130,246,0.12)',
    highlight: 'rgba(59,130,246,0.22)',
  },
  memory: {
    bg: 'bg-gradient-to-br from-pink-300 to-pink-500',
    ring: 'ring-pink-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(219,39,119,0.14)',
    highlight: 'rgba(219,39,119,0.22)',
  },
  orchestration: {
    bg: 'bg-gradient-to-br from-cyan-300 to-cyan-500',
    ring: 'ring-cyan-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(6,182,212,0.14)',
    highlight: 'rgba(6,182,212,0.22)',
  },
  human: {
    bg: 'bg-gradient-to-br from-orange-300 to-orange-500',
    ring: 'ring-orange-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(251,146,60,0.14)',
  ...
  action: {
    ...
    ring: 'ring-indigo-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(99,102,241,0.14)',
    highlight: 'rgba(99,102,241,0.22)',
  },
  input: {
    ...
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(168,85,247,0.14)',
    highlight: 'rgba(168,85,247,0.22)',
  },
  'denbegaye-agent': {
    bg: 'bg-gradient-to-br from-rose-500 via-purple-500 to-indigo-600',
    ring: 'ring-rose-400',
    icon: 'text-white',
    glow: '0 4px 24px 0 rgba(244,63,94,0.24)',
