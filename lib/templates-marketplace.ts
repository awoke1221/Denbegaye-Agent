...
export const builtInTemplates: Template[] = [
  {
    ...
    description:
      'Autonomously generates, improves, stores, and optionally posts high-quality social media content using AI, memory, and tool integrations.',
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          config: {
            prompt:
              'Create viral social media content about {topic} using these trends: {trends} and style from: {pastPosts}',
            model: 'gemini-pro',
          },
        },
      },
  ...
  },
  {
    ...
    description:
      'Automates email campaign creation, personalization, and scheduling with AI-powered content generation.',
    category: 'Marketing',
  ...
  },
  {
    ...
    description:
      'Automatically analyzes datasets, generates insights, and creates comprehensive reports with visualizations.',
    category: 'Analytics',
  ...
  },
  {
    ...
    description:
      'Handles customer inquiries, provides instant responses, and escalates complex issues automatically.',
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          config: {
            prompt:
              'Analyze this customer inquiry and determine category, sentiment, and urgency: {message}',
            model: 'gemini-pro',
          },
        },
      },
