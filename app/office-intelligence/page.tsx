      ...
      <aside className="w-[240px] min-w-[240px] bg-[#e9e4dd] border-r border-[#d7d0c8] flex flex-col h-full overflow-hidden">
        <div className="h-[72px] border-b border-[#d7d0c8] px-3.5 py-2.5 flex items-center gap-3 bg-[#e9e4dd]">
          ...
          <div className="min-w-0">
            <div className="text-[14px] font-semibold text-[#1e1e1e] leading-tight">AgentSuite</div>
                ...
                {OFFICE_CATEGORIES.map(category => {
                  ...
                  return (
                    <button
                      key={category.id}
                      onClick={() =>
                        setSelectedCategory(selectedCategoryId === category.id ? null : category.id)
                      }
        ...
        <div className="p-3 border-t border-[var(--border-default)] flex-shrink-0">
          <div className="flex items-center gap-2">
            <div className="w-6.5 h-6.5 rounded-full flex items-center justify-center text-[10px] font-medium flex-shrink-0 bg-[var(--bg-subtle)] text-[var(--text-primary)] border border-[var(--border-default)]">
              JD
            </div>
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[10px] text-[var(--text-tertiary)] leading-tight">Pro plan</div>
            </div>
                ...
                {activeMessages.length === 0 ? (
                  <div className="max-w-[88%] self-start flex flex-col">
                    ...
                    <div className="text-[13px] text-[var(--text-primary)] leading-relaxed rounded-[10px] px-3 py-2 border-l-2 border-[var(--border-strong)] bg-[var(--bg-subtle)]">
                      Hi! I'm your {activeCategory?.name}. Upload a file in the panel on the right,
                      then ask me anything — I'll write and execute Python to answer.
                    </div>
                  </div>
                ) : (
