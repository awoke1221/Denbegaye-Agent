...
import { Sparkles, Chrome, Github, Mail, Lock, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#02040f] text-white p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-cyan-200">Start your journey with Denbegnaye</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span style={{ color: '#222' }}>Sign up with Google</span>
                </Button>
                <Button
                  style={{
                    background: '#181717',
                ...
                >
                  ...
                  <span style={{ color: '#fff' }}>Sign up with GitHub</span>
                </Button>
              </div>
